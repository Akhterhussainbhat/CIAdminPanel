            ...
            <div class="card card1">
                <div class="row justify-content-center my-auto">
                    <div class="col-md-10 col-10 my-10">
                        ...
                        <form action="<?php echo base_url().'UserFile/userSite/login';?>" method="POST">
                        <div class="form-group"> <label class="form-control-label text-muted">Email</label> <input type="text" id="email" name="email" placeholder="Email" class="form-control"><?php echo form_error('email', '<div class="error">', '</div>'); ?> </div>
                ...
                <div class="bottom text-center mb-5">
                    <p  class="sm-text mx-auto mb-3">Don't have an account? <a href="<?php echo base_url().'UserFile/usersite/registration'?>" ><button class="btn btn-white ml-2">Create new</button></a></p>
                </div>
            </div>
